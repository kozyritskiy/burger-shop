...
"use strict";var map=void 0;function initMap(){map=new google.maps.Map(document.getElementById("map"),{zoom:12,center:new google.maps.LatLng(59.937747,30.319899),mapTypeId:"roadmap"});var p={shop:{icon:"./svg/map-marker.svg"}};[{position:new google.maps.LatLng(59.939417,30.239682),type:"shop"},{position:new google.maps.LatLng(59.963922,30.302334),type:"shop"},{position:new google.maps.LatLng(59.903399,30.347748),type:"shop"}].forEach(function(o){new google.maps.Marker({position:o.position,icon:p[o.type].icon,map:map})})}
